...
class resnet_v1_101_rfcn_cg(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        psroipooled_cls_rois = mx.contrib.sym.PSROIPooling(name='psroipooled_cls_rois', data=rfcn_cls, rois=rois, group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS,
                                                   output_dim=num_classes, spatial_scale=0.0625)
        psroipooled_loc_rois = mx.contrib.sym.PSROIPooling(name='psroipooled_loc_rois', data=rfcn_bbox, rois=rois, group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS,
