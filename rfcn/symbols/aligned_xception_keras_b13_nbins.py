...
class aligned_xception_keras_b13_nbins(Symbol):
    ...
    def get_xception_feat(self, data):
        ...
        b1 = mx.sym.BatchNorm(b1, name='block1_conv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        b1 = mx.sym.BatchNorm(b1, name='block1_conv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        rs2 = mx.sym.BatchNorm(rs2, name='batchnormalization_1', use_global_stats=self.use_global_stats, eps=self.eps)

        b2 = self.separable_conv(b1, 64, 128, (3, 3), (1, 1), 'block2_sepconv1')
        b2 = mx.sym.BatchNorm(b2, name='block2_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        b2 = mx.sym.Activation(b2, act_type='relu', name='block2_sepconv1_act')
        b2 = self.separable_conv(b2, 128, 128, (3, 3), (1, 1), 'block2_sepconv2')
        b2 = mx.sym.BatchNorm(b2, name='block2_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        rs3 = mx.sym.BatchNorm(rs3, name='batchnormalization_2', use_global_stats=self.use_global_stats, eps=self.eps)

        b3 = mx.sym.Activation(b2, act_type='relu', name='block3_sepconv1_act')
        b3 = self.separable_conv(b3, 128, 256, (3, 3), (1, 1), 'block3_sepconv1')
        b3 = mx.sym.BatchNorm(b3, name='block3_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        b3 = mx.sym.Activation(b3, act_type='relu', name='block3_sepconv2_act')
        b3 = self.separable_conv(b3, 256, 256, (3, 3), (1, 1), 'block3_sepconv2')
        b3 = mx.sym.BatchNorm(b3, name='block3_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        b4 = self.separable_conv(b4, 256, 728, (3, 3), (1, 1), 'block4_sepconv1')
        b4 = mx.sym.BatchNorm(b4, name='block4_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        b4 = mx.sym.Activation(b4, act_type='relu', name='block4_sepconv2_act')
        b4 = self.separable_conv(b4, 728, 728, (3, 3), (1, 1), 'block4_sepconv2')
        b4 = mx.sym.BatchNorm(b4, name='block4_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        for i in range(8):
            ...
            b = self.separable_conv(b, 728, 728, (3, 3), (1, 1), prefix + '_sepconv1')
            b = mx.sym.BatchNorm(b, name=prefix + '_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
            b = mx.sym.Activation(b, act_type='relu', name=prefix + '_sepconv2_act')
            b = self.separable_conv(b, 728, 728, (3, 3), (1, 1), prefix + '_sepconv2')
            b = mx.sym.BatchNorm(b, name=prefix + '_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
            b = mx.sym.Activation(b, act_type='relu', name=prefix + '_sepconv3_act')
            b = self.separable_conv(b, 728, 728, (3, 3), (1, 1), prefix + '_sepconv3')
            b = mx.sym.BatchNorm(b, name=prefix + '_sepconv3_bn', use_global_stats=self.use_global_stats, eps=self.eps)

            b = b + residual

        rs5 = mx.sym.Convolution(b, num_filter=1024, kernel=(1, 1), stride=(1, 1),
                                 no_bias=True, name='convolution2d_4')
        rs5 = mx.sym.BatchNorm(rs5, name='batchnormalization_4', use_global_stats=self.use_global_stats, eps=self.eps)

        b13 = mx.sym.Activation(b, act_type='relu', name='block13_sepconv1_act')
        b13 = self.separable_conv(b13, 728, 728, (3, 3), (1, 1), 'block13_sepconv1')
        b13 = mx.sym.BatchNorm(b13, name='block13_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        b13 = mx.sym.Activation(b13, act_type='relu', name='block13_sepconv2_act')
        b13 = self.separable_conv(b13, 728, 1024, (3, 3), (1, 1), 'block13_sepconv2')
        b13 = mx.sym.BatchNorm(b13, name='block13_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        b13 = b13 + rs5
        b = b13
        return b
    ...
    def get_xception_exit_flow(self, b):
        ...
        b14 = self.separable_conv(b, 1024, 1536, (3, 3), (2, 2), 'block14_sepconv1', dilate=(2, 2))
        b14 = mx.sym.BatchNorm(b14, name='block14_sepconv1_bn', use_global_stats=self.use_global_stats, eps=self.eps)
        ...
        b14 = self.separable_conv(b14, 1536, 2048, (3, 3), (2, 2), 'block14_sepconv2', dilate=(2, 2))
        b14 = mx.sym.BatchNorm(b14, name='block14_sepconv2_bn', use_global_stats=self.use_global_stats, eps=self.eps)
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        conv_new_1 = mx.sym.Convolution(data=conv_exit_flow, kernel=(1, 1), num_filter=1024, name="conv_new_1")
