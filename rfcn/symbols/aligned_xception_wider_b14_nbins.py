...
class aligned_xception_wider_b14_nbins(Symbol):
    ...
    def get_xception_feat(self, data):
        ...
        b14 = self.separable_conv(b13, 1024, 2048, (3, 3), (2, 2), 'block14_sepconv1', dilate=(2, 2))
    ...
    def get_xception_exit_flow(self, b):
        ...
        b14 = self.separable_conv(b, 2048, 2048, (3, 3), (2, 2), 'block14_sepconv2', dilate=(2, 2))
