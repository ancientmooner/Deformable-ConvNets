...
class resnet_v1_101_rfcn_dcn_cg(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        # conv_new_1
        conv_new_1 = mx.sym.Convolution(data=relu1, kernel=(1, 1), num_filter=cfg.network.CONVNEW_CHANNEL, name="conv_new_1", lr_mult=3.0)
        relu_new_1 = mx.sym.Activation(data=conv_new_1, act_type='relu', name='relu1')

        # rfcn_cls/rfcn_bbox
        rfcn_cls = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=cfg.network.NBINS*cfg.network.NBINS*num_classes, name="rfcn_cls")
        rfcn_bbox = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=cfg.network.NBINS*cfg.network.NBINS*4*num_reg_classes, name="rfcn_bbox")
        # trans_cls / trans_cls
        rfcn_cls_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=2 * cfg.network.NBINS * cfg.network.NBINS * num_classes, name="rfcn_cls_offset_t")
        rfcn_bbox_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=cfg.network.NBINS * cfg.network.NBINS * 2, name="rfcn_bbox_offset_t")

        rfcn_cls_offset = mx.contrib.sym.DeformablePSROIPooling(name='rfcn_cls_offset', data=rfcn_cls_offset_t, rois=rois, group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS,
                                                                sample_per_part=4, no_trans=True, part_size=cfg.network.NBINS, output_dim=2 * num_classes, spatial_scale=0.0625)
        rfcn_bbox_offset = mx.contrib.sym.DeformablePSROIPooling(name='rfcn_bbox_offset', data=rfcn_bbox_offset_t, rois=rois, group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS,
                                                                 sample_per_part=4, no_trans=True, part_size=cfg.network.NBINS, output_dim=2, spatial_scale=0.0625)
        ...
        psroipooled_cls_rois = mx.contrib.sym.DeformablePSROIPooling(name='psroipooled_cls_rois', data=rfcn_cls, rois=rois, trans=rfcn_cls_offset,
                                                                     group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS, sample_per_part=4, no_trans=False, trans_std=0.1,
                                                                     output_dim=num_classes, spatial_scale=0.0625, part_size=cfg.network.NBINS)
        psroipooled_loc_rois = mx.contrib.sym.DeformablePSROIPooling(name='psroipooled_loc_rois', data=rfcn_bbox, rois=rois, trans=rfcn_bbox_offset,
                                                                     group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS, sample_per_part=4, no_trans=False, trans_std=0.1,
                                                                     output_dim=8, spatial_scale=0.0625, part_size=cfg.network.NBINS)
        cls_score = mx.sym.Pooling(name='ave_cls_scors_rois', data=psroipooled_cls_rois, pool_type='avg', global_pool=True, kernel=(cfg.network.NBINS, cfg.network.NBINS))
        bbox_pred = mx.sym.Pooling(name='ave_bbox_pred_rois', data=psroipooled_loc_rois, pool_type='avg', global_pool=True, kernel=(cfg.network.NBINS, cfg.network.NBINS))
    ...
    def get_symbol_rfcn(self, cfg, is_train=True):
        ...
        conv_new_1 = mx.sym.Convolution(data=relu1, kernel=(1, 1), num_filter=cfg.network.CONVNEW_CHANNEL, name="conv_new_1",
        ...
        rfcn_bbox = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=cfg.network.NBINS * cfg.network.NBINS * 4 * num_reg_classes,
                                       name="rfcn_bbox",
        ...
        rfcn_cls_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=2 * cfg.network.NBINS * cfg.network.NBINS * num_classes,
        ...
        rfcn_bbox_offset_t = mx.sym.Convolution(data=relu_new_1, kernel=(1, 1), num_filter=cfg.network.NBINS * cfg.network.NBINS * 2,
        ...
        rfcn_cls_offset = mx.contrib.sym.DeformablePSROIPooling(name='rfcn_cls_offset', data=rfcn_cls_offset_t,
                                                                rois=rois, group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS,
                                                                sample_per_part=4, no_trans=True, part_size=cfg.network.NBINS,
        ...
        psroipooled_cls_rois = mx.contrib.sym.DeformablePSROIPooling(name='psroipooled_cls_rois', data=rfcn_cls,
                                                                     ...
                                                                     group_size=cfg.network.NBINS, pooled_size=cfg.network.NBINS, sample_per_part=4,
                                                                     no_trans=False, trans_std=0.1,
                                                                     output_dim=num_classes, spatial_scale=0.0625,
                                                                     part_size=cfg.network.NBINS)
